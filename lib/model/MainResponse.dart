...
class SplashConfiguration {
  ...
  SplashConfiguration({this.id, this.firstColor, this.secondColor, this.title, this.titleColor, this.enableTitle, this.enableLogo, this.enableBackground, this.splashLogoUrl, this.splashBackgroundUrl});
