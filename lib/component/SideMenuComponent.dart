            ...
            ListView.separated(
              ...
              itemBuilder: (context, i) {
                return SettingItemWidget(
                  ...
                  leading: appStore.isDarkModeOn == true ? cachedImage(mPagesList![i].image, width: 22, height: 22, color: context.iconColor) : cachedImage(mPagesList![i].image, width: 22, height: 22),
                  onTap: () {
